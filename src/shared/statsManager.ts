...
export default class StatsManager implements IStatsManager {

	public static clean() {
		Memory.stats = {};
	};

	public static getStats(json: boolean): string|Object {
		if (json) {
	...
	public addStat(key: string, value: string|Object): void {
	...
	public roomExpensive(stats: StatsObject, room: Room) {
